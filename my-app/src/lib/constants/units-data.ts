...
export const unitsData: Unit[] = [
  {
    ...
    name: 'Alphaville',
    city: 'Goiânia — GO',
    description: '3.500 m² na Av. Alphaville Flamboyant, ao lado do AlphaPark Hotel. É a única unidade da rede com box de CrossFit, e a que abre mais cedo: 4h30.',
    ...
    specialFeatures: [
      'Box de CrossFit',
      'Treinadores certificados em CrossFit',
      'WOD novo todo dia',
  ...
  },
  {
    ...
    name: 'Buena Vista',
    city: 'Goiânia — GO',
    description: '2.550 m² dentro do Shopping Buena-Vista, no Setor Bueno. Treino e o resto do dia resolvidos no mesmo endereço — e também abre às 4h30.',
    ...
    specialFeatures: [
      'Salas dedicadas para coletivas',
  ...
  },
  {
    ...
    name: 'Marista',
    city: 'Goiânia — GO',
    description: '2.600 m² na Av. Portugal, dentro do Assaí Atacadista do Setor Marista. É a unidade com aulas para terceira idade.',
  ...
  },
  {
    ...
    name: 'Palmas',
    city: 'Palmas — TO',
    description: '3.498 m² na Quadra 206 Sul, a primeira Flex fora de Goiás. É a única com piscina semi-olímpica, sauna úmida e hidromassagem.',
