...
const unitRecipients: Record<string, string> = {
  ...
  'palmas': 'comercial@flexacademia.com.br,comercial.atendimento@flexacademia.com.br,financeiro@flexacademia.com.br,vendaspalmas@flexacademia.com.br,gestaotecnica@flexpalmas.com.br'
}
...
const procedureNames: Record<string, string> = {
  ...
  'trancamento-pago': 'Trancamento Pago R$ 150,00',
          ...
          >
            ...
            <CustomSelect
              ...
              options={[
                ...
                { value: 'trancamento-pago', label: 'Trancamento Pago R$ 150,00' },
